...
/** Default handler; always returns True as the defaultReadMetadata function 
...
/** Default metadata reader; extracts file's name, size and modificaation date 
**/
